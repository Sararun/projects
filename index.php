...
//Программирование - не выученный синтаксис языка, программирование - умение решать задачи.

//Сложность - в умении выстроить эту структуру, это и отличает хорошего программиста,
//он куда более элегантен в своих решениях.

//цель чтобы заставить мозг напрягаться и с каждым днем решать все более сложные задачи.

//Нужно понимать, ЧТО, КАК и ЗАЧЕМ вы делаете, при написании кода.
